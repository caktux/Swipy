...
if(options.animate_onload){$(document).on('ready',function(e){$(options.page).css({x:'100%',scale:options.scale});});$(window).on('load',function(e){$(options.page).transition({x:0},options.speed,'out').transition({scale:1,},options.speed,'in');});}}
